          ...
          <div class="items row isotope boxed grid-view">
            ...
            <div class="item grid-sizer col-6 col-sm-6 col-md-4 col-lg-3">
              <div class="box bg-white shadow p-20">
                <figure class="main mb-20 overlay overlay1 rounded"><a href="/profile/{{$article->author_id}}#BeforeAfter">
                  <img src="https://img.youtube.com/vi/{{$article->link}}/0.jpg" alt="" /></a>
                  <figcaption>
                    <h5 class="text-uppercase from-top mb-0"><a href="/profile/{{$article->author_id}}#BeforeAfter">Read more</a></h5>
                      <p></p>
                  </figcaption>
                    <div class="category"><a href="/profile/{{$article->author_id}}#BeforeAfter">{{$article->getCategories()[0]->name}}</a></div>
                </figure>
                  
                <h6 class="mb-0"><a href="/profile/{{$article->author_id}}#BeforeAfter">{{ucwords(strtolower($article->title))}}</a></h6>
